                ...
                <tbody>
                    @foreach($alertesProduits as $alerte)
                        <tr class="hover:bg-gray-50 border-b border-gray-200">
                            <td class="px-4 py-2">{{ $alerte->produit->libelle ?? 'Produit inconnu' }}</td>
                            <td class="px-4 py-2">
                            ...
                            <td class="px-4 py-2">
                                <a href="{{ route('alertes-produits.show', $alerte) }}" class="text-indigo-600 hover:underline" title="voir">
                                    <button type="button">
