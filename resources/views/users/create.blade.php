...
@section('content')
    ...
    @if ($user && $user->hasRole('admin'))
        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <input type="text" name="nom" id="nom" value="{{ old('nom') }}" required pattern="[^,;:]+"
                title="Ne doit pas contenir les caractères , ; :"><br><br>

            <label for="nom_pseudo">Nom Pseudo:</label><br>
            <input type="text" name="nom_pseudo" id="nom_pseudo" value="{{ old('nom_pseudo') }}" required
                pattern="[^,;:]+" title="Ne doit pas contenir les caractères , ; :"><br><br>

            <label for="prenom">Prénom :</label><br>
            <input type="text" name="prenom" id="prenom" value="{{ old('prenom') }}" required pattern="[^,;:]+"
                title="Ne doit pas contenir les caractères , ; :"><br><br>

            <label for="adresse">Adresse :</label><br>
            <input type="text" name="adresse" id="adresse" value="{{ old('adresse') }}" required pattern="[^,;:]+"
                title="Ne doit pas contenir les caractères , ; :"><br><br>

            <label for="telephone">Téléphone :</label><br>
            <input type="tel" name="telephone" id="telephone"
                pattern="^(70|71|72|73|74|75|76|77|78|79|90|91|92|93|94|95|96|97|98|99)[0-9]{6}$" maxlength="8" required
            ...
            <input type="email" name="email" id="email" value="{{ old('email') }}" required pattern="[^,;:]+"
                title="Ne doit pas contenir les caractères , ; :"><br><br>
