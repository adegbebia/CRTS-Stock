    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <!-- Voir -->
                    <a href="{{ route('articles.show', $article->produit_id) }}">
                        <button type="button">
                    ...
                    <!-- Modifier -->
                    <a href="{{ route('articles.edit', $article->produit_id) }}">
                        <button type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <!-- Supprimer -->
                    <form action="{{ route('articles.destroy', $article->produit_id) }}"
                    ...
                    <br>
                    <a href="{{ route('mouvements.create', ['produit' => $article->produit_id]) }}">
