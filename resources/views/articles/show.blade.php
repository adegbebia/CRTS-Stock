...
<div class="max-w-3xl mx-auto mt-8 bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
    <div class="flex items-center mb-8 pb-4 border-b-2 border-red-600">
        ...
        <h2 class="text-3xl font-bold text-gray-900">Détails de l'Alerte Article</h2>
    </div>
    ...
    <div class="bg-gray-50 rounded-xl p-6 mb-8 border border-gray-200">
        <div class="space-y-4">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->codearticle }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->libelle }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->conditionnement }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->quantitestock }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->stockmax }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->stockmin }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->stocksecurite }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 border-b border-gray-200">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->dateperemption }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3">
                ...
                <span class="text-gray-900 font-semibold mt-2 sm:mt-0">{{ $article->lot }}</span>
            </div>
        </div>
    </div>
