    ...
    <div class="max-w-4xl mx-auto mt-8 bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
        ...
        @if($alerte->article)
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                <h3 class="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    <i class="fa-solid fa-bowl-food text-red-600 mr-2"></i>
                    Informations de l'Article lié
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->libelle ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1 flex items-center">
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->quantitestock ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1 flex items-center">
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->conditionnement ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1 flex items-center">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->stocksecurite ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1 flex items-center">
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->stockmin ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1 flex items-center">
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->stockmax ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600 mb-1 flex items-center">
                        ...
                        <p class="font-medium text-gray-900">{{ $alerte->article->lot ?? 'N/A' }}</p>
                    </div>
                </div>
            </div>
        @else
            <div class="mt-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg">
                <div class="flex items-start">
                    ...
                    <p class="text-red-800 font-medium">⚠️ Aucune information de l'article disponible pour cette alerte.</p>
                </div>
            </div>
        @endif
