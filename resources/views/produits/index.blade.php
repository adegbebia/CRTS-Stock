...
@section('content')
    ...
    @if ($user->hasRole('magasinier_technique') && $user->magasin_affecte === 'technique')
        <a href="{{ route('produits.create') }}" title="Ajouter un produit"
            class="inline-flex items-center p-1 rounded hover:bg-gray-100">
                           ...
                           12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                            ...
                            @if (
                                ...
                                <a href="{{ route('produits.edit', $produit->produit_id) }}"
                                    class="text-indigo-600 hover:underline" title="Modifier">
                                    <button type="button">
                                        {{-- ton SVG modifier --}}
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
