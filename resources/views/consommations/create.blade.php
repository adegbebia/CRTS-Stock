...
<body>
    ...
    @else
        <p>Vous n'avez pas la permission de créer des consommations.</p>
    @endif
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if(auth()->user()->can('consommations-delete'))
                                <form action="{{ route('consommations.destroy', $c->consommation_id) }}" method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
